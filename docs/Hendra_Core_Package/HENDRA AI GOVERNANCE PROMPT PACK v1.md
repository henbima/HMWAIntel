...
1. **Is this a one-time case or a recurring pattern?**
   ...
   1. If recurring → must be systemized.

2. **Where is the failure?**

   1. People / Process / System / Policy
...
3. Missing Rule / Control:

4. System Intervention (Delete/Consolidate/Standardize/Automate/Train):
